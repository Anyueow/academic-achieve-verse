...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-secondary to-background pt-12 overflow-hidden">
      {/* Fullscreen Hero Collage Image */}
      <img
        src="/hero-collage.png"
        alt="Ananya Shah - collage of work and community moments"
        className="absolute inset-0 w-full h-full object-cover object-center z-0"
        style={{ boxShadow: 'none', border: 'none', background: 'none', pointerEvents: 'none', opacity: 0.3 }}
      />
      {/* Optional overlay for contrast */}
      <div className="absolute inset-0 bg-background/80 z-10" />
      <div className="container mx-auto px-4 md:px-6 py-12 md:py-24 relative z-20">
